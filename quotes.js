const quotes = [
  ...
  "A strange thing is memory, and hope; one looks backward, and the other forward; one is of today, the other of tomorrow. ~ Anna Mary Robertson ('Grandma') Moses",
  ...
  "As I see it, in everything that we do, we need to come down on the side of life and hope. ~ F. Tustin",
  "Believe in the incredible power of the human mind. Of doing something that makes a difference. Of working hard. Of laughing and hoping. ~ Dream Big",
  ...
  "Each of us has the power to give life meaning, to make our time and our bodies and our words into instruments of love and hope. ~ Tom Head",
  "Each time a person stands up for an ideal, or acts to improve the lot of others, or strikes out against injustice, he sends forth a tiny ripple of hope, and crossing each other from a million different centers of energy and daring, these ripples build a current that can sweep down the mightiest walls of oppression and resistance. ~ Robert F. Kennedy",
  "Enthusiasm is the yeast that makes your hopes rise to the stars. ~ Henry Tor",
  ...
  "Have hope. Though clouds environs now, And gladness hides her face in scorn, Put thou the shadow from thy brow - No night but hath its morn. ~ J. C. F. von Schiller",
  ...
  "Hope cherishes no illusions, nor does it yield to cynicism. ~ Father James Keller",
  "Hope dies last. (Or Hope is the last thing to be lost) (Lo ultimo que muere es la esperanza) ~ Spanish proverb",
  "Hope discovers what can be done instead of grumbling about what cannot. ~ Father James Keller",
  ...
  "Hope is a satisfaction unto itself, and need not be fulfilled to be appreciated. ~ Dr. Fred O. Henker",
  ...
  "Hope is life's greatest treasure. ~ Daisaku Ikeda",
  ...
  "Hope is man's inner effort. ~ Sri Chinmoy",
  ...
  "Hope is not a dream, but a way of making dreams become reality. ~ L. J. Cardinal Suenens",
  ...
  "Hope is the 'yes' to life ~ Dr. Ronna Jevne",
  ...
  "Hope is the feeling that life and work have a meaning. You either have it or you don't, regardless of the state of world that surrounds you. ~ Vaclav Havel",
  ...
  "Hope lights a candle instead of cursing the darkness. ~ Father James Keller",
  "Hope means believing in spite of the evidence, and then watching the evidence change. ~ Jim Wallis",
  "Hope opens doors where despair closes them. ~ Father James Keller",
  "Hope plays an integral part in knowing - knowing myself, knowing others. ~ Casey Boodt",
  "Hope puts up with modest gains, realizing that the longest journey starts with one step. ~ Father James Keller",
  "Hope regards problems, small or large, as opportunities. ~ Father James Keller",
  ...
  <p>
    ...
    still, as darker grows the night,", "Emits a brighter ray. ~ Oliver
    Goldsmith",
  </p>,
  ...
  "Hopes, dreams, faith and a sense of mission enable us to open up our lives. ~ Daisaku Ikeda",
  ...
  "I know that you cannot live on hope alone, but without it, life is not worth living. And you, and you, and you, and you have got to give them hope.” ~ Harvey Milk",
  ...
  "If there is a reason to be hopeful, be hopeful.  It doesn't jinx anything. ~ Author Unknown",
  ...
  "In fact, hope is best gained after defeat and failure, because then inner strength and toughness is produced. ~ Fritz Napp",
  "In our lives, where there is hope, the impossible moves within our grasp, and what seems difficult to reach waits but a breath away. ~ Author unknown",
  ...
  "It is important for me to share my experiences in order to create strength and hope for others. No matter how far down you go, it is never too late to come back. ~ Theo Fleury",
  ...
  "It's hope as a decision that makes change possible. ~ Jim Wallis",
  "It's the possibility that keeps me going, not the guarantee. ~ Nicholas Sparks (The Notebook)",
  <p>
    "Know then, whatever cheerful and serene", "Supports the mind, supports the
    body too:", "Hence, the most vital movement mortals feel", "Is hope, the
    balm and lifeblood of the soul. ~ John Armstrong",
  </p>,
  "A leader is a dealer in hope. ~ Napoleon Bonaparte",
  "Learn from yesterday, live for today, hope for tomorrow. ~ Albert Einstein",
  "Let your hopes, not your hurts, shape your future. ~ Robert H. Schuller",
  "A life without hope is bleak and grey. If you have no hope, create some. ~ Daisaku Ikeda",
  ...
  "No matter how difficult life can be the most important thing is to live it with hope. ~ Author Unknown",
  ...
  "Now the God of hope fills you with all joy and peace in believing, that ye may abound in hope. ~ Bible",
  ...
  "Oft hope is born when all is forlorn. ~ J. R. R. Tolkein (The Return of the King)",
  ...
  "One of the finest lessons nature can teach us is that of hope. She shows us hope realized with every bud that blossoms and every bird that learns to fly. ~ Author unknown",
  ...
  "Our hopes are but memories reversed. ~ Author Unknown",
  "Our hopes, desires and ambitions are powerful forces existing within us for the shaping of the future. They are the generating forces that create the future. ~ Daisaku Ikeda",
  ...
  "The hope or climbing aspiration of a divine child is to receive and achieve Peace, Light and Bliss in infinite measure. ~ Sri Chinmoy",
  ...
  "Though you are disappointed is hope; never let hope fail you! Though one door is shut, there are thousands still open to you. ~ Ruckett",
  ...
  "To hope means to be ready at every moment for that which is not yet born, and yet not become desperate if there is no birth in our lifetime … those whose hope is strong see and cherish all signs of new life and are ready every moment to help the birth of that which is ready to be born. ~ Erich Fromm",
  <p>
    "To hope, then, means to take a playful leap" "into the future—to dare to
    spring from firm ground—" "to play trustingly—invest energy, laughter;" "And
    one good leap encourages another—" "On then with the dance. ~ Joan M.
    Erikson
  </p>,
  "To possess an undaunting Hope: Believe that in the midst of confusion and bewilderment, one is capable of seeking and holding onto the way toward a future possessing insight and vision. ~'Ike Pono 'Oe",
  ...
  "When we feel defeated, we need only take a deep breath and say, 'Yes,' and hope will reappear ~ Monroe Forester",
  "When we live with hope we do not get tangled up with concerns for how our wishes will be fulfilled. (…) Hope includes an openness by which you wait for the promise to come through, even though you never know when, where, or how this might happen. ~ Henri Nouwen",
  "When you're at the end of your rope, tie a knot and hold on. ~ Theodore Roosevelt",
  "When you do nothing, you feel overwhelmed and powerless. But when you get involved, you feel the sense of hope and accomplishment that comes from knowing you are working to make things better. ~ Pauline R. Kezer",
  "Where some see despair, others see hope. Hope then, like beauty, is in the eye of the beholder. ~ Wendy Edey",
  "Where there is creativity, there is hope. ~ Donna Karan",
  "Where there is no hope, it is incumbent on us to invent it. ~ Albert Camus",
  <p>
    "Whether we be young or old,", "Our destiny, our being's heart and home,",
    "Is with infinitude, and only there;", "With hope it is, hope that can never
    die,", "Effort and expectation, and desire,", "And something evermore about
    to be. ~ William Wordsworth",
  </p>,
  "While there's life, there's hope. ~ Cicero",
  "",
  "You are here in order to enable the world to live more amply, with greater vision, with a finer spirit of hope and achievement. ~ Woodrow Wilson",
  ...
  <p>
    "Tonight, I send you hope.", "May it be the lens of your life’s vision,",
    "may it always help awaken your passion,", "may it help ignite your
    convictions,", "may you be a stubborn, indefatigable hero of hope - hope’s
    champion.", "And when dark doubts surge, may you be hope’s harbor –", "A
    caretaker and defender of hope. ~ Senator Corey Booker",
  </p>,
  "I have never quite understood what false hope is. All hope is 'false' in the sense that what is hoped for may not materialize. At the time of hoping one cannot know the outcome. If the hope serves to improve one's quality of life and does not cause one to avoid taking adaptive action when it is possible, nor be resentful when the hoped-for outcome does not materialize, then it is obviously desirable. ~ A. H. Epstein, 1989, p. xxv",
];
